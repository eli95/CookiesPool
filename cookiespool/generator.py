...
from login.robo.cookies import RoboCookies
...
class RoboCookiesGenerator(CookiesGenerator):
    def __init__(self, website='robo'):
        """
        初始化操作
        :param website: 站点名称
    ...
    def new_cookies(self, username, password):
        ...
        :return: 用户名和Cookies
        """
        return RoboCookies(username, password, self.browser).main()


if __name__ == '__main__':
    generator = RoboCookiesGenerator()
    generator.run()
